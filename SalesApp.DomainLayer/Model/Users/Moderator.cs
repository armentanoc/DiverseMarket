namespace SalesApp.DomainLayer.Model.Users
{
    public class Moderator : User
    {
        ...
        public Moderator(string username, string name, string email, string password, int phone, Address address, RolesEnum role = RolesEnum.Moderator) : base(username, name, email, password, phone, role, address)
        {
