...
{
    partial class AddSpecificProductPage
    {
        ...
        private void InitializeComponent(ProductBasicInfoDTO productBasicInfoDTO, long userId)
        {
            this._userId = userId;
            this._basicProduct = productBasicInfoDTO;
