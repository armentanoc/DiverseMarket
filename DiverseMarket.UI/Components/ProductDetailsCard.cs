...
{
    public class ProductDetailsCard : Panel
    {
        public ProductDetailsCard(ProductOfferCompleteInfoDTO productOfferInfo)
        {
            Width = 1169;
            Height = 151;
            BorderStyle = BorderStyle.None;
            //AddAddress(customerName, deliveryAddress);
            AddTotalAmount(productOfferInfo.Price);

        }

        private void AddTotalAmount(decimal totalAmount)
        {
